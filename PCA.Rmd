...
Based on the loading plot below, the 1st PC appears to capture term frequency. Token count is positioned on the far left and implies a topic's terms appears often in the corpus. The 2nd PC appears to capture term specificity. Uniform entropy is located at the top and implies a the topic word distributions capture more information than a uniform distribution.  
