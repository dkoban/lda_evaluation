...
plot_ly(plot_df, 
  ...
  add_markers() %>%
  layout(scene = list(xaxis = list(title = 'PC1 - Topic Frequency',  zerolinewidth = 1),
                     yaxis = list(title = 'PC2 - Top Term Specificity',  zerolinewidth = 1),
